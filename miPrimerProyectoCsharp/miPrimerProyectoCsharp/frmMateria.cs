    ...
    public partial class frmMateria : Form
    {
        ...
        private void mostrarDatos()
        {
            if (objDt.Rows.Count > 0)
            {
                ...
                lblRegistrosMateria.Text = (posicion + 1) + " de " + objDt.Rows.Count;
            }
        }
        ...
        private void filtrarDatos(String valor)
        {
            try
            {
                ...
                {
                    objDv.RowFilter = ""; // Sin filtro, muestra todo
                }
                else
                {
                    ...
                    {
                        case 0: //codigo
                            // Si codigo es texto, usa comillas simples
                            objDv.RowFilter = "codigo = '" + valor + "'";
                            // Si es numérico, usa: objDv.RowFilter = "codigo = " + valor;
                            break;
                        case 1: //nombre
        ...
        private void grbBusquedaMateria_Enter(object sender, EventArgs e)
        {
