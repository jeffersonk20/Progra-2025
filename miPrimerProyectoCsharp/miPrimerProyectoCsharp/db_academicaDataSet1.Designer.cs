...
namespace miPrimerProyectoCsharp {
    ...
    public partial class db_academicaDataSet1 : global::System.Data.DataSet {
        ...
        public partial class periodoDataTable : global::System.Data.TypedTableBase<periodoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public periodoRow AddperiodoRow(string Periodo, System.DateTime fecha) {
        ...
        public partial class periodoRow : global::System.Data.DataRow {
            ...
            public System.DateTime fecha {
                get {
                    return ((global::System.DateTime)(this[this.tableperiodo.fechaColumn]));
                }
                set {
                    this[this.tableperiodo.fechaColumn] = value;
                }
            }
        }
...
namespace miPrimerProyectoCsharp.db_academicaDataSet1TableAdapters {
    ...
    public partial class periodoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[periodo] WHERE (([idPeriodo] = @Original_idPeriodo) AND ([Peri" +
                "odo] = @Original_Periodo) AND ([fecha] = @Original_fecha))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[periodo] ([Periodo], [fecha]) VALUES (@Periodo, @fecha);\r\nSELE" +
                "CT idPeriodo, Periodo, fecha FROM periodo WHERE (idPeriodo = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[periodo] SET [Periodo] = @Periodo, [fecha] = @fecha WHERE (([idPeriodo] = @Original_idPeriodo) AND ([Periodo] = @Original_Periodo) AND ([fecha] = @Original_fecha));
SELECT idPeriodo, Periodo, fecha FROM periodo WHERE (idPeriodo = @idPeriodo)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT idPeriodo, Periodo, fecha FROM dbo.periodo";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(db_academicaDataSet1.periodoDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual db_academicaDataSet1.periodoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            db_academicaDataSet1.periodoDataTable dataTable = new db_academicaDataSet1.periodoDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(db_academicaDataSet1.periodoDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
